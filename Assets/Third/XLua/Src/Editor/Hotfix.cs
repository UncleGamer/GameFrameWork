...
namespace XLua
{
    public static class Hotfix
    {
        ...
        public static void HotfixInject()
        {
            ...
            string assembly_csharp_clone_path = Directory.GetParent(Application.dataPath).FullName + "/Tools/Assembly-CSharp.dll";
            string assembly_csharp_clone_Directory = Path.GetDirectoryName(assembly_csharp_clone_path);
            if (Directory.Exists(assembly_csharp_clone_Directory))
            {
                assembly_csharp_path = Path.GetFullPath(assembly_csharp_path);
                File.Copy(assembly_csharp_path, assembly_csharp_clone_path, true);
                File.Copy(assembly_csharp_path + ".mdb", assembly_csharp_clone_path + ".mdb", true);
            }
