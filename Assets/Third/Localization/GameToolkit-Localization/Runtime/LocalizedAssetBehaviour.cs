...
namespace GameToolkit.Localization
{
    ...
    public abstract class LocalizedAssetBehaviour : MonoBehaviour
    {
        ...
        //CurrentLanguage
        private Language m_CurrentLanguage = Language.Unknown;
        ...
        {
            if (Application.isPlaying && m_CurrentLanguage != Localization.Instance.CurrentLanguage)
            {
                ForceUpdateComponentLocalization();
                m_CurrentLanguage = Localization.Instance.CurrentLanguage;
            }
