...
//        }
    ...
    static void AddBuild(string bundleName, string path)
    {
...
//                ToLuaMenu.CopyLuaBytesFiles(srcDirs[i], streamDir);
	...
	static void HandleHotUpdateBundle() {
        ...
        //AddBuildMap("View" + AppConst.ExtName, "*.prefab", "Assets/ResourcesOut/UI/Prefabs/View");
        AddBuild("UINoticeTip" + AppConst.ExtName, "Assets/ResourcesOut/UI/Prefabs/Common/UINoticeTip.prefab");

        AddBuildMap("Atlas_Comm" + AppConst.ExtName, "*.png", "Assets/ResourcesOut/UI/Atlas/Comm");
    }
    ...
    static void BuildAssetsIndex()
    {
        string resPath = AppDataPath + "/" + AppConst.AssetDir + "/";
        ///----------------------创建文件列表-----------------------
        string newFilePath = resPath + "/assets.txt";
        if (File.Exists(newFilePath)) File.Delete(newFilePath);
        ...
        foreach (var item in maps)
        {
            ...
            {
                keyValuePairs.Add(item.assetNames[i].ToLower(), item.assetBundleName.ToLower());
            }
        }
        string json = Newtonsoft.Json.JsonConvert.SerializeObject(keyValuePairs,Newtonsoft.Json.Formatting.Indented);
