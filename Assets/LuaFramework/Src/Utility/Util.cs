...
namespace LuaFramework {
	public class Util {
		...
		public static void Log(string str) {
			Debug.Log($"<color=cyan> {DateTime.Now.ToString()} [Info] </color> {str}");
		}

		public static void LogWarning(string str) {
            Debug.Log($"<color=yellow> {DateTime.Now.ToString()} [Warning] </color> {str}");
		}

		public static void LogError(string str) {
            Debug.Log($"<color=red> {DateTime.Now.ToString()} [Error] </color> {str}");
        }
