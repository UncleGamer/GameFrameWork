...
namespace LuaFramework {
	public class GameManager : Manager {
		...
		void OnInitialize() {
			...
			LuaManager.DoString("require 'GameMain'");//加载游戏
            //LuaManager.DoString("require 'UnitTest/NetWorkTest'");      //加载网络
			NetManager.OnInit();                     //初始化网络
			Util.CallMethod("GameMain", "Start");     //初始化,游戏启动
...
//		}
        ...
        {
            Util.CallMethod("GameMain", "OnApplicationQuit");
        }
    }
}