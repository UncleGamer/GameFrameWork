...
local function OnCreate(self)
	base.OnCreate(self)
	self.login_btn = UIUtil.FindButton(self.gameObject, login_btn_path)
	UIUtil.AddButtonOnClick(self, self.login_btn, self.OnRefresh)
--[[
	-- 初始化各个组件
...
local function OnRefresh(self)
	UIManager:GetInstance():Broadcast(UIMessageNames.UILOGIN_ON_SELECTED_SVR_CHG)
...
local function OnDestroy(self)
	UIUtil.ClearButtonOnClick(self.login_btn)
